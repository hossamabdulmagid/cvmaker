...
import {
    ...
    AiTwotoneFolderOpen,
    AiTwotoneFileExcel, AiTwotonePlaySquare
} from "react-icons/ai";
                        ...
                        (<Alert>
                            <LinkOption to='/login'>
                                <strong>
                                 ...
                                 for download and save for  now Or later editing,
                                you will need to signup or login by clicking the 'Save' button (your CV will automatically be added to your account).
                            </LinkOption>
                        </Alert>)
                    }
                    <div className="row">
                        ...
                        <div className="col-2">
                            ...
                            <LinkForPremium to='/cv'>
                                Upgrade to Premium ♥
                            </LinkForPremium>
                        </div>
                        <Col className="col-6">

                            <Buttons size="xs" variant='success'> <AiOutlineExclamation />  Help</Buttons>
                            <Buttons size="xs" variant='success'> <AiTwotoneFileExcel /> Quick preview</Buttons>
                            {currentUser ?
                                (<Fragment>
                        ...
                        <RapperSidebar className="col-3" >
                            <Ul>
                                <Li href="#" onClick={(e) => { e.preventDefault(); setActiveSection("Basic information") }}>
                                    <LINK>
                                        Basic information
                                    </LINK>
                                </Li>
                                {sidebarRoutes.map((singleRouteforSidebar, x) => (
                                    <Li href="#" onClick={(e) => { e.preventDefault(); setActiveSection(singleRouteforSidebar) }} key={x}>
                                        <LINK>
                                    ...
                                    <ModalContent>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            <ModalBody pb={6}>
                                                ...
                                                <Input placeholder="SectionName" type="text" name="section" ref={register({ required: 'this content is required' })} />
                                                {errors.section && errors.section.message}
                                            </ModalBody>
                                            <ModalFooter>
                                                <Button variantColor="blue" mr={3} type="submit" onClick={AddToList} onOpen>
                                                    Save
                                                </Button>
                            ...
                            <small>
                                * Click and drag section names in the above list to reorder sections in your CV.
                            </small> <br />
                            <small>
